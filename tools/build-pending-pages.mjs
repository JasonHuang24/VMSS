...
const banner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Ratification status">
          ...
          <div>
            ...
            <p><strong>FAILED PETITION</strong> — 1–4 at gauntlet; advocacy review 3–2, short of the zero-fail threshold. That verdict remains final and its authored figures never activated law. The later <a href="law-polling.html#lp-074">LP-074</a> successor was a distinct conditional statute. Its 2294 Path 2 audit passed Findings I&ndash;IV and independently certified Schedules A and B, making <strong>50 / 25 / 12.5 / 6.25</strong> effective in 2295. All three original briefs publish as historical record, not current-rate authority.</p>
          </div>
        </div>`;
...
const statuteBanner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Statute status">
          <i class="fas fa-scale-balanced" aria-hidden="true"></i>
          <div>
            <span class="pb-label">Enacted · Conditions not satisfied · Schedules inactive</span>
            <p><strong>ENACTED — SCHEDULES ACTIVE FROM 2295.</strong> <a href="law-polling.html#lp-074">LP-074</a> registered 5–0 and changed no rate on passage. The 2294 Path 2 audit passed Findings I&ndash;IV, certified Schedule A, independently passed B1&ndash;B6, and certified Schedule B. Valid notice made the complete <strong>50 / 25 / 12.5 / 6.25</strong> schedule effective in 2295. This page preserves the conditional statute exactly as filed.</p>
          </div>
        </div>`;
...
built.push(page({
  ...
  description: 'Historical ballot text for the failed RATIFY-TAX-50 petition, retained with its briefs. Its authored evidence never activated law; the later conditional successor certified independently in 2294.',
...
built.push(page({
  ...
  description: 'The full enacted text of LP-074 — governing rule, Schedules A and B, A1–A8 and B1–B6, evidentiary quarantine, and cadence rider. Both schedules certified in 2294 and became active in 2295.',
  heroKicker: 'Ratification Record · Full Statute Text',
  heroTitle: 'RATIFY-TAX-50-II — Full Conditional Statute',
  heroSub: 'The instrument as filed and enacted: the conditional rule the chambers voted. Its 2294 Path 2 audit certified Schedule A and then independently certified Schedule B.',
  crosslinks: [
    ...
    link('path-2-certification-2294.html', '', 'fa-clipboard-check', '2294 final disposition — complete record'),
...
const hubBody = [
  ...
  `<p class="pending-p"><strong>FAILED PETITION.</strong> The original petition would have reduced the §12.1 top-marginal schedule to <strong>50&nbsp;/&nbsp;25&nbsp;/&nbsp;12.5&nbsp;/&nbsp;6.25</strong>. It failed 1–4 at gauntlet and 3–2 on advocacy review, and its authored evidence never activated anything. The later LP-074 conditional successor was a distinct enactment. Its 2294 Path 2 audit passed Findings I&ndash;IV and independently certified Schedules A and B, making the complete cascade effective in 2295.</p>`,
  `<p class="pending-p">What survived the original failure was the direction. Every chamber endorsed the trajectory principle even while refusing the magnitude then supported — 5–0 across the ratification chambers — and it stands as the <a href="whitepaper.html#trajectory-doctrine">Trajectory Doctrine</a> at Whitepaper §12.1. The later successor proceeded on independently locked audit evidence; it did not retroactively validate the failed petition&rsquo;s authored figures. All three original briefs publish as permanent historical record.</p>`,
  ...
  `<p class="pending-p" style="margin-top:1.4rem">Those questions received a rulebook: the <a href="path-2-charter.html">Path&nbsp;2 Charter</a>, its <a href="path-2-schedule.html">§10.4 Schedule</a>, and its <a href="path-2-risk-register.html">Residual-Risk Register</a>. The first 2279&ndash;2288 window closed without a run. <a href="law-polling.html#lp-075">LP-075</a> later compelled the remedial process that locked in 2292. The <a href="path-2-certification-2294.html">2294 certification</a> passed Findings I&ndash;IV and independently certified both LP-074 schedules. Valid notice made 50 / 25 / 12.5 / 6.25 effective in 2295.</p>`,
  `<div class="pending-crosslinks" style="margin-top:1.25rem">\n` +
    [link('path-2-charter.html', 'is-primary', 'fa-scale-balanced', 'Path 2 Charter — certification methodology'),
...
built.push(page({
  ...
  description: 'The drafting archive behind the civilization’s ratification record. RATIFY-TAX-50 failed and remains failed; the later independently audited LP-074 successor certified both schedules in 2294.',
