...
const banner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Ratification status">
          ...
          <div>
            ...
            <p><strong>FAILED PETITION</strong> — 1–4 at gauntlet; advocacy review 3–2, short of the zero-fail threshold. Its historical 70 / 35 / 17 / 8 context remains part of this record. The current operative composite schedule is <strong>50 / 35 / 17 / 8</strong>: <a href="law-polling.html#lp-074">LP-074 Schedule A</a> certified in 2294 and became effective in 2295, while <a href="law-polling.html#lp-073">LP-073</a> remains authority for the lower rates. All three briefs — opposition, advocacy, and supplemental — publish as permanent record. The later result activates LP-074 on audited facts; it does not reopen or validate this failed petition.</p>
          </div>
        </div>`;
...
const statuteBanner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Statute status">
          <i class="fas fa-scale-balanced" aria-hidden="true"></i>
          <div>
            <span class="pb-label">Enacted · Schedule A active · Schedule B pending</span>
            <p><strong>ENACTED, CONDITIONAL RULE.</strong> <a href="law-polling.html#lp-074">LP-074</a> registered 5–0 and changed no rate on passage. Its final <a href="path-2-certification-2294.html">2294 Schedule A certification</a> activates the 50% Sanctuary/Main rate from 2295; Schedule B remains pending its separate Lower Incidence Certificate. The operative composite is <strong>50 / 35 / 17 / 8</strong>, with <a href="law-polling.html#lp-073">LP-073</a> retaining the lower-rate authority. This page preserves the full conditional statute as filed; its historical conditional language is not retroactively rewritten.</p>
          </div>
        </div>`;
...
built.push(page({
  ...
  description: 'Ballot text for RATIFY-TAX-50 (petition v4.1) — the federal law proposal that would have reduced the Charter §12.1 top-marginal schedule to 50/25/12.5/6.25. It failed its gauntlet 1–4 and reached only 3–2 on advocacy review, short of the zero-fail threshold. Retained as historical record alongside its opposition, advocacy, and supplemental briefs; the later LP-074 Schedule A certificate independently established the current 50/35/17/8 composite.',
...
built.push(page({
  ...
  description: 'The full text of RATIFY-TAX-50-II, the register’s conditional rate law (LP-074) — governing rule, the gated Schedule A and Schedule B, certification conditions A1–A8 and B1–B6, the evidentiary quarantine, and the cadence rider. Schedule A certified in 2294 and is effective in 2295; Schedule B remains pending.',
  heroKicker: 'Ratification Record · Full Statute Text',
  heroTitle: 'RATIFY-TAX-50-II — Full Conditional Statute',
  heroSub: 'The instrument as filed and enacted: the rule the chambers actually voted, every condition the Path 2 audit must certify before a rate moves, and the citations tying each clause to the record that produced it. Registered at LP-074; Schedule A was certified in 2294 and is active from 2295, while Schedule B remains pending.',
  crosslinks: [
    link('law-polling.html#lp-074', 'is-primary', 'fa-scale-balanced', 'LP-074 — the register entry'),
    link('law-polling.html#lp-073', '', 'fa-layer-group', 'LP-073 — residual lower-rate authority'),
