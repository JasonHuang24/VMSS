...
const banner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Ratification status">
          ...
          <div>
            ...
            <p><strong>FAILED PETITION</strong> — 1–4 at gauntlet; advocacy review 3–2, short of the zero-fail threshold. That verdict remains final and its authored figures never activated law. The later <a href="law-polling.html#lp-074">LP-074</a> successor also changed no rate: its corrected 2294 Path 2 execution failed Finding III. <a href="law-polling.html#lp-073">LP-073</a>&rsquo;s <strong>70 / 35 / 17 / 8</strong> schedule therefore remains operative. All three original briefs publish as historical record, not current-rate authority.</p>
          </div>
        </div>`;
...
const statuteBanner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Statute status">
          ...
          <div>
            ...
            <p><strong>ENACTED, CONDITION NOT SATISFIED.</strong> <a href="law-polling.html#lp-074">LP-074</a> registered 5–0 and changed no rate on passage. The corrected 2294 execution refused Schedule A at Finding III. No Lower adoption or Schedule B certificate followed, and the proposed <strong>50 / 25 / 12.5 / 6.25</strong> schedule never activated. This page preserves the conditional statute exactly as filed; <strong>LP-073&rsquo;s 70 / 35 / 17 / 8 schedule remains operative</strong>.</p>
          </div>
        </div>`;
...
const processFrame = () => `
        <div class="process-frame" role="note" aria-label="Record tier">
          ...
          <p>This section is the <strong>drafting archive</strong>: the out-of-world authorship history behind the civilization's fiscal law. It is not a page of the world's own record and nothing in it is in force. The archive keeps <strong>interventions and their withdrawal alike</strong>. In world, <strong>RATIFY-TAX-50 failed</strong>; the later LP-074 conditional successor was also refused after corrected Path 2 Finding III failed. <a href="law-polling.html#lp-073">LP-073</a>&rsquo;s 70 / 35 / 17 / 8 schedule remains operative.</p>
        </div>`;
...
built.push(page({
  ...
  description: 'Historical ballot text for the failed RATIFY-TAX-50 petition, retained with its briefs. Its authored evidence never activated law; the later conditional successor was also refused after corrected Path 2 Finding III failed.',
...
built.push(page({
  ...
  description: 'The full enacted text of LP-074 — governing rule, Schedules A and B, A1–A8 and B1–B6, evidentiary quarantine, and cadence rider. The corrected 2294 execution refused Schedule A at Finding III; no rate changed.',
  heroKicker: 'Ratification Record · Full Statute Text',
  heroTitle: 'RATIFY-TAX-50-II — Full Conditional Statute',
  heroSub: 'The instrument as filed and enacted: the conditional rule the chambers voted. Its corrected 2294 Path 2 execution refused Schedule A at Finding III, so the separate Lower Incidence pathway was not reached.',
  crosslinks: [
...
const hubBody = [
  ...
  `<p class="pending-p"><strong>FAILED PETITION.</strong> The original petition would have reduced the §12.1 top-marginal schedule to <strong>50&nbsp;/&nbsp;25&nbsp;/&nbsp;12.5&nbsp;/&nbsp;6.25</strong>. It failed 1–4 at gauntlet and 3–2 on advocacy review, and its authored evidence never activated anything. The later LP-074 conditional successor was tested in a distinct, reproducible 2294 execution, but Finding III failed and Schedule A was refused. LP-073&rsquo;s 70&nbsp;/&nbsp;35&nbsp;/&nbsp;17&nbsp;/&nbsp;8 therefore remains operative.</p>`,
  ...
  `<p class="pending-p" style="margin-top:1.4rem">Those questions received a rulebook: the <a href="path-2-charter.html">Path&nbsp;2 Charter</a>, its <a href="path-2-schedule.html">§10.4 Schedule</a>, and its <a href="path-2-risk-register.html">Residual-Risk Register</a>. The first 2279&ndash;2288 window closed without a run. <a href="law-polling.html#lp-075">LP-075</a> later compelled the remedial process that locked in 2292. The corrected <a href="path-2-certification-2294.html">2294 disposition</a> refused Schedule A at Finding III. No Lower adoption or Schedule B certificate followed, so LP-073 remains operative.</p>`,
  `<div class="pending-crosslinks" style="margin-top:1.25rem">\n` +
    [link('path-2-charter.html', 'is-primary', 'fa-scale-balanced', 'Path 2 Charter — certification methodology'),
...
built.push(page({
  ...
  description: 'The drafting archive behind the civilization’s ratification record. RATIFY-TAX-50 failed and remains failed; the later independently audited LP-074 successor was refused after corrected Path 2 Finding III failed.',
