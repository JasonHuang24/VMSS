...
/* Standing status banner, carried by every page in the section. It states the
   ...
   This petition failed and stays failed — the succession is a fact about the
   line, not a reversal of its verdict. The later statute and audit activate
   LP-074, not the failed petition or its authored figures. */
const banner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Ratification status">
          ...
          <div>
            ...
            <p><strong>FAILED PETITION</strong> — 1–4 at gauntlet; advocacy review 3–2, short of the zero-fail threshold. Its historical 70 / 35 / 17 / 8 context remains part of this record. The current operative schedule is <strong>50 / 25 / 12.5 / 6.25</strong>: <a href="law-polling.html#lp-074">LP-074</a>&rsquo;s final 2294 certificate independently cleared Schedule A&rsquo;s A1&ndash;A8 and Schedule B&rsquo;s B1&ndash;B6 findings, making both schedules effective in 2295. <a href="law-polling.html#lp-073">LP-073</a> is preserved as historical law and fully superseded as an operative rate schedule. All three briefs — opposition, advocacy, and supplemental — publish as permanent record. The later result reached the same destination on independently audited facts; it does not reopen or validate this failed petition.</p>
          </div>
        </div>`;
...
/* The successor's banner. The failed-petition banner above is the section's
   ...
   long conditional statute most needs first: which schedule, if any, has
   actually activated. */
const statuteBanner = () => `
        <div class="pending-banner mb-10" role="note" aria-label="Statute status">
          <i class="fas fa-scale-balanced" aria-hidden="true"></i>
          <div>
            <span class="pb-label">Enacted · Schedules A and B active</span>
            <p><strong>ENACTED, CONDITIONAL RULE.</strong> <a href="law-polling.html#lp-074">LP-074</a> registered 5–0 and changed no rate on passage. Both Schedules A and B were certified in 2294 and are active from 2295: A1&ndash;A8 for Schedule A and B1&ndash;B6 for Schedule B. Its complete exact schedule is <strong>50 / 25 / 12.5 / 6.25</strong>. <a href="law-polling.html#lp-073">LP-073</a> is fully superseded as operative rate law and preserved as history. This page preserves the full conditional statute as filed; its historical conditional language is not retroactively rewritten.</p>
          </div>
        </div>`;
...
built.push(page({
  ...
  description: 'Ballot text for RATIFY-TAX-50 (petition v4.1) — the federal law proposal that would have reduced the Charter §12.1 top-marginal schedule to 50/25/12.5/6.25. It failed its gauntlet 1–4 and reached only 3–2 on advocacy review, short of the zero-fail threshold. Retained as historical record alongside its opposition, advocacy, and supplemental briefs; the later LP-074 certificate independently established the same exact cascade after both schedules certified.',
...
built.push(page({
  ...
  description: 'The full text of RATIFY-TAX-50-II, the register’s conditional rate law (LP-074) — governing rule, the gated Schedule A and Schedule B, certification conditions A1–A8 and B1–B6, the evidentiary quarantine, and the cadence rider. Both schedules certified in 2294 and the exact 50/25/12.5/6.25 cascade is effective from 2295.',
  heroKicker: 'Ratification Record · Full Statute Text',
  heroTitle: 'RATIFY-TAX-50-II — Full Conditional Statute',
  heroSub: 'The instrument as filed and enacted: the rule the chambers actually voted, every condition the Path 2 audit must certify before a rate moves, and the citations tying each clause to the record that produced it. Registered at LP-074; its final 2294 certificate independently cleared both schedules, activating the exact 50/25/12.5/6.25 cascade from 2295.',
  crosslinks: [
    link('law-polling.html#lp-074', 'is-primary', 'fa-scale-balanced', 'LP-074 — the register entry'),
    link('law-polling.html#lp-073', '', 'fa-layer-group', 'LP-073 — historical rate law'),
    link('law-polling.html#lp-075', '', 'fa-hourglass-start', 'LP-075 — commencement duty'),
    link('path-2-certification-2294.html', '', 'fa-clipboard-check', '2294 certification — final record'),
...
const hubBody = [
  ...
  `<p class="pending-p" style="margin-top:1.4rem">Those questions received a rulebook. The methodology that answered Schedule A — the <a href="path-2-charter.html">Path&nbsp;2 Charter</a>, its <a href="path-2-schedule.html">§10.4 Schedule</a>, and its <a href="path-2-risk-register.html">Residual-Risk Register</a> — was adopted by the chambers in 2279 (Y178), fixed in advance so that no run could shop its own verdict. The first 2279&ndash;2288 window lawfully closed without a run under the original §12.3. <a href="law-polling.html#lp-075">LP-075</a> later compelled the remedial run. The final <a href="path-2-certification-2294.html">2294 certificate</a> independently cleared Schedule A&rsquo;s A1&ndash;A8 and Schedule B&rsquo;s B1&ndash;B6, making LP-074&rsquo;s complete exact <strong>50&nbsp;/&nbsp;25&nbsp;/&nbsp;12.5&nbsp;/&nbsp;6.25</strong> cascade active from 2295.</p>`,
  `<div class="pending-crosslinks" style="margin-top:1.25rem">\n` +
    [link('path-2-charter.html', 'is-primary', 'fa-scale-balanced', 'Path 2 Charter — certification methodology'),
...
built.push(page({
  ...
  description: 'The drafting archive behind the civilization’s ratification record. RATIFY-TAX-50 — the proposed §12.1 top-marginal reduction to 50/25/12.5/6.25 — failed its gauntlet 1–4 and reached only 3–2 on advocacy review. Its historical record is retained; the later 2294 certificate independently activates both LP-074 schedules, not the failed petition.',
