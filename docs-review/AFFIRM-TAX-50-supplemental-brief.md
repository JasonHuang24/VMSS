...
3. **The current gate treatment cannot become a reusable epistemic loophole.**
...
4. **The median voter's apparent risk asymmetry omits the cost and irreversibility of rejection.**
...
5. **The concentration objection mistakes a higher bounded equilibrium for uncontrolled compounding.**
...
6. **The treasury sensitivity contains its own advance-detection mechanism.**
...
7. **Lower's unidentified incidence is a reason to demand justification for the tax—not to preserve it automatically.**
...
8. **The schedule is a conservative ratchet, not a retreat from public obligation.**
...
9. **The permanent adverse record proves the trust function no longer requires confiscatory posture.**
